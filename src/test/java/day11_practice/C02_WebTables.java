...
public class C02_WebTables extends TestBase {
    ...
    public void test01() {
        ...
        int satir=3;//burada satir ve sutun numaralarina istedigmizi yazarak
        int sutun=3;//istedigimiz hucreye dinamik kod'lar sayesinde gidebiliriz
        //WebElement arananCell=driver.findElement(By.xpath("//tbody//tr[3]//td[3]"));
        //System.out.println(arananCell.getText()); //dinamik olmayan kodlar
